  ...
  return (
    <div>
        ...
        <section>
          <h2>previously</h2>
          <ul>
            <li>industrial engineer @ <a href="https://www.gatech.edu">georgia tech</a> - a lot of statistics.</li>
        ...
        <section>
          ...
          <ul>
            ...
            <li><a href="https://findflayr.com">flayrai</a> - capstone project turned accelerator. tried to fix restaurant hiring. poor founder/market fit.</li>
            <li><a href="https://iterate.tools">iterate.tools</a> - building a new way to interact with computers. sign up today!</li>
          </ul>
        </section>
        ...
        <section>
          ...
          <ul>
            <li><a href="https://github.com/williamgay25/nexus">nexus</a> - doing some nlp on my journal entries.</li>
